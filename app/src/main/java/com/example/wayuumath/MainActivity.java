...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int id;
        if (num_aleatorio == 0 || num_aleatorio == 10 || num_aleatorio == 5) {
            id = getResources().getIdentifier("lapiz", "drawable", getPackageName());
            ...
            id = getResources().getIdentifier("ardilla", "drawable", getPackageName());
            iv_personaje.setImageResource(id);
    ...
    public void Jugar(View view) {
        ...
        if(!nombre.equals("")){
            ...
            Toast.makeText(this, "Para iniciar, priemro agrega tu nombre", Toast.LENGTH_SHORT).show();
